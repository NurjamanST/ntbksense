...
// Path ini akan mencari root WordPress dengan naik 4 level dari file ini.
// Sesuaikan angka '4' jika struktur folder lo berbeda.
 ...
 * Bisa CREATE atau UPDATE secara otomatis.
 */
function handle_ntbksense_database_settings_update()
{
    ...
    if ($result === false) {
        http_response_code(500);
        // [PERBAIKAN] Tambahkan $wpdb->last_error untuk melihat error SQL yang asli
        echo json_encode([
            'success' => false,
