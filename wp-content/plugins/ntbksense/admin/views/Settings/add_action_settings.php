            ...
            $("#settingsForm").submit(function(e) {
                ...
                $.ajax({
                    ...
                    .done(function(response) {
                        // 'response' bisa jadi string atau objek, tergantung server
                        // Kita cek dulu apakah 'success' ada di dalemnya
                    ...
                    .fail(function(jqXHR) {
                        // Ini akan jalan kalau ada error 404, 500, atau JSON rusak
                        const errorMessage = jqXHR.responseJSON?.message || "Koneksi gagal atau respon server tidak valid.";
                        showNotification(errorMessage, "error");
                    })
                    .always(function() {
                        // Ini DIJAMIN akan selalu jalan, baik sukses maupun gagal
