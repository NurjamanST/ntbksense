...
?>
    ...
    <!-- jQuery is already loaded by WordPress admin -->
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            // --- START: Logika Tambah/Hapus Input ---
            ...
            // --- END: Logika Tambah/Hapus Input ---

            // --- START: Logika Toggle Advance ---
            ...
            // 2. Kirim permintaan AJAX saat tombol di dalam modal diklik
            $('#submit-get-articles').on('click', function(e) {
                ...
                $originalButton.html('<span class="spinner is-active" style="float: left; margin-right: 5px;"></span> Memuat...');
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        count: articleCount // Kirim jumlah yang diinginkan
                    },
                    success: function(response) {
                        if (response.success) {
                            const urls = response.data.join('\n');
                            $textarea.val(urls);
                        } else {
        ...
        <form method="post" action="" id="ntb-create-lp-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="ntb-form-group">
                                    ...
                                    <input type="text" id="cloaking_url" name="ntb_cloaking_url" class="form-control" placeholder="https://www.google.com/">
                                </div>
                            </div>
                        </div>
                        <!-- Bawah -->
                                    ...
                                    <div class="ntb-simple-view">
                                        ...
                                        <div id="ntb-video-urls-container">
                                            <div class="input-group">
                                                <input type="text" name="ntb_url_video[]" class="form-control" placeholder="https://example.com/video.mp4">
                                ...
                                <div class="ntb-form-group">
                                    <div class="ntb-simple-view">
                                        ...
                                        <div id="ntb-image-urls-container">
                                            <div class="input-group">
                                                <input type="text" name="ntb_url_gambar[]" class="form-control" placeholder="https://example.com/image.jpg">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="ntb-form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="ntb_param_key" class="form-control" placeholder="target">
                                        <span class="input-group-text">=</span>
                                        <input type="text" name="ntb_param_value" class="form-control" placeholder="200">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="ntb-form-group col-md-6">
                                        ...
                                        <div class="ntb-range-slider">
                                            ...
                                            <div class="slider-inputs">
                                                <input type="number" name="ntb_jeda_video_min" class="form-control range-value-min" value="9">
                                                <span class="range-separator"><-></span>
                                                <input type="number" name="ntb_jeda_video_max" class="form-control range-value-max" value="24">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="ntb-form-group col-md-6">
                                        ...
                                        <div class="ntb-range-slider">
                                            <div class="slider-track" data-min="0" data-max="30"></div>
                                            <div class="slider-inputs">
                                                <input type="number" name="ntb_waktu_refresh_min" class="form-control range-value-min" value="9">
                                                <span class="range-separator"><-></span>
                                                <input type="number" name="ntb_waktu_refresh_max" class="form-control range-value-max" value="24">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="ntb-form-group">
                                    ...
                                    <input type="text" id="judul_manual" name="ntb_judul_manual" class="form-control" placeholder="Watch Now Videos">
                                </div>
                            </div>
                        </div>
                        <!-- Bawah -->
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="ntb-form-group">
                                    ...
                                    <textarea id="daftar_artikel" name="ntb_daftar_artikel" class="form-control" rows="5" placeholder="Klik tombol 'Dapatkan URL Artikel' untuk mengisi otomatis..."></textarea>
                                </div>
                                <div class="ntb-form-group">
                                    <label for="deskripsi_manual">Deskripsi Manual</label>
                                    <textarea id="deskripsi_manual" name="ntb_deskripsi_manual" class="form-control" rows="5" placeholder="1"></textarea>
                                </div>
                                <div class="ntb-form-group">
                                    <label for="inject_keywords">Inject Keywords</label>
                                    <textarea id="inject_keywords" name="ntb_inject_keywords" class="form-control" rows="5" placeholder="Pisahkan dengan koma | keyword1,keyword"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="ntb-form-footer">
                ...
                <button type="submit" class="button button-primary">
                    <span class="dashicons dashicons-arrow-right-alt2"></span> Submit
                </button>
            </div>
        </form>
    </div>
